        ...
        stage ('SonarQube Analysis') {
            ...
            steps {
                withSonarQubeEnv('Sonar-local-test') {
                    sh "${scannerHome}/bin/sonar-scanner -e -Dsonar.projectKey=DeployBackend -Dsonar.host.url=http://172.17.0.1:9000 -Dsonar.login=sqp_793b439115b4d752ff11bf59434ed693ad3d7abb -Dsonar.java.binaries=target"
